...
Apps creëren meer overzicht binnen een workspace en helpen het team hun werk op te volgen \autocite{PodioFeatures}. Elke app wordt opgebouwd uit een samenvoeging van bouwblokken of velden, deze staan gelijst in \ref{tab:Tabel 1}. Bovendien heeft Podio ook een app store die bestaat uit pasklare apps, zo kunnen managers een bruikbare applicatie opzetten in slechts enkele minuten tijd \autocite{TallyfyPodio}. 
